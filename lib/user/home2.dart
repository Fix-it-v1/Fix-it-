                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return (snapshot.data!.docs[index]['firstName']
                                ...
                                snapshot.data!.docs[index]['provideType'] == 'Electricity' )? buildUserItem(context, snapshot, index) : SizedBox(height: 0,);
                          },
                        ),
                      );
                    }
                        ...
                        if (!snapshot.hasData) {
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return (snapshot.data!.docs[index]['provideType'] == 'Electricity')?buildUserItem(context, snapshot, index):SizedBox(height: 0,);
                            },
                            separatorBuilder: (context, index) {
                              return (snapshot.data!.docs[index]['provideType'] == 'Electricity')? SizedBox(
                                height: 24,
                              ):SizedBox(height: 0,);
                            },
