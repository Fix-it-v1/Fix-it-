                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            .toLowerCase()
                                ...
                                snapshot.data!.docs[index]['provideType'] == 'Plumping' )? buildUserItem(context, snapshot, index) : SizedBox(height: 0,);
                          },
                        ),
                      );
                    }
                        ...
                        if (!snapshot.hasData) {
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return (snapshot.data!.docs[index]['provideType'] == 'Plumping')?buildUserItem(context, snapshot, index):SizedBox(height: 0,);
                            },
                            separatorBuilder: (context, index) {
                              return (snapshot.data!.docs[index]['provideType'] == 'Plumping')? SizedBox(
                                height: 24,
                              ):SizedBox(height: 0,);
                            },
