...
import 'package:project/user/ContactUs.dart';
import 'package:project/user/controller_home/home_cubit.dart';
import 'package:project/user/ordersList.dart';
import 'package:project/user/settings.dart';
    ...
    return Scaffold(
      body: SafeArea(
        child: SingleChildScrollView(
          child: (state is GetProfileDataLoadingState)? const Center(child: CircularProgressIndicator()) :Column(
            children: [
              ...
              Container(
                ...
                child: Image(
                  image: NetworkImage(cubit.dataUserModel.image.toString()),
                ),
                height: 90.0,
                width: 90.0,
              ),
