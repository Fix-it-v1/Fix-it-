...
import 'package:project/technical/registerTechnical.dart';
...
class TechnicalLogin extends StatefulWidget {
  const TechnicalLogin({Key? key}) : super(key: key);

  @override
  State<TechnicalLogin> createState() => _TechnicalLoginState();
}

class _TechnicalLoginState extends State<TechnicalLogin> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          BlocConsumer<AuthTechCubit, AuthTechState>(
                            ...
                            {
                            if (state is LoginTechSuccessState)
                            {
                            ...
                            if(state is LoginTechErrorState)
                            {
                                ...
                                child: MaterialButton(
                                  ...
                                  onPressed: () {
                                    if (formKey.currentState!.validate()) {
                                     AuthTechCubit.get(context).technicalSignIn(email: emailController.text, password: passwordController.text);
                                    }
                                  },
                                  child: Text(
                                    'LOGIN',
